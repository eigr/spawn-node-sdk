 ...
 *
 * @generated from protobuf message eigr.functions.protocol.JSONType
 */
...
class Context$Type extends MessageType<Context> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* eigr.functions.protocol.actors.ActorId caller */ 2:
                    message.caller = ActorId.internalBinaryRead(reader, reader.uint32(), options, message.caller);
                    break;
    ...
    private binaryReadMap4(map: Context["metadata"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof Context["metadata"] | undefined, val: Context["metadata"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field eigr.functions.protocol.Context.metadata");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    private binaryReadMap5(map: Context["tags"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof Context["tags"] | undefined, val: Context["tags"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field eigr.functions.protocol.Context.tags");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message: Context, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.caller)
            ActorId.internalBinaryWrite(message.caller, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* eigr.functions.protocol.actors.ActorId self = 3; */
        if (message.self)
            ActorId.internalBinaryWrite(message.self, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
...
// @generated message type with reflection information, may provide speed optimized methods
class JSONType$Type extends MessageType<JSONType> {
    constructor() {
        super("eigr.functions.protocol.JSONType", [
            { no: 1, name: "content", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<JSONType>): JSONType {
        const message = { content: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<JSONType>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: JSONType): JSONType {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: JSONType, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string content = 1; */
        if (message.content !== "")
...
/**
 * @generated MessageType for protobuf message eigr.functions.protocol.JSONType
 */
export const JSONType = new JSONType$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class SpawnRequest$Type extends MessageType<SpawnRequest> {
    ...
    create(value?: PartialMessage<SpawnRequest>): SpawnRequest {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<SpawnRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SpawnRequest): SpawnRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SpawnRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated eigr.functions.protocol.actors.ActorId actors = 1; */
        for (let i = 0; i < message.actors.length; i++)
            ActorId.internalBinaryWrite(message.actors[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SpawnResponse$Type extends MessageType<SpawnResponse> {
    ...
    create(value?: PartialMessage<SpawnResponse>): SpawnResponse {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<SpawnResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SpawnResponse): SpawnResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SpawnResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* eigr.functions.protocol.RequestStatus status = 1; */
        if (message.status)
            RequestStatus.internalBinaryWrite(message.status, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
class SideEffect$Type extends MessageType<SideEffect> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* eigr.functions.protocol.InvocationRequest request */ 1:
                    message.request = InvocationRequest.internalBinaryRead(reader, reader.uint32(), options, message.request);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SideEffect, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.request)
            InvocationRequest.internalBinaryWrite(message.request, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Broadcast$Type extends MessageType<Broadcast> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Any value */ 3:
                    message.payload = {
                        oneofKind: "value",
                        value: Any.internalBinaryRead(reader, reader.uint32(), options, (message.payload as any).value)
                    };
                    break;
                case /* eigr.functions.protocol.Noop noop */ 4:
                    message.payload = {
                        oneofKind: "noop",
                        noop: Noop.internalBinaryRead(reader, reader.uint32(), options, (message.payload as any).noop)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Broadcast, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.payload.oneofKind === "value")
            Any.internalBinaryWrite(message.payload.value, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* eigr.functions.protocol.Noop noop = 4; */
        if (message.payload.oneofKind === "noop")
            Noop.internalBinaryWrite(message.payload.noop, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Pipe$Type extends MessageType<Pipe> {
    ...
    create(value?: PartialMessage<Pipe>): Pipe {
        const message = { actor: "", actionName: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Forward$Type extends MessageType<Forward> {
    ...
    create(value?: PartialMessage<Forward>): Forward {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<Forward>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Forward): Forward {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Forward, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string actor = 1; */
        if (message.actor !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.actor);
        /* string action_name = 2; */
...
class Workflow$Type extends MessageType<Workflow> {
    constructor() {
        super("eigr.functions.protocol.Workflow", [
            ...
            { no: 1, name: "effects", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SideEffect },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* eigr.functions.protocol.Pipe pipe */ 3:
                    message.routing = {
                        oneofKind: "pipe",
                        pipe: Pipe.internalBinaryRead(reader, reader.uint32(), options, (message.routing as any).pipe)
                    };
                    break;
                case /* eigr.functions.protocol.Forward forward */ 4:
                    message.routing = {
                        oneofKind: "forward",
                        forward: Forward.internalBinaryRead(reader, reader.uint32(), options, (message.routing as any).forward)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Workflow, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.broadcast)
            Broadcast.internalBinaryWrite(message.broadcast, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* repeated eigr.functions.protocol.SideEffect effects = 1; */
        for (let i = 0; i < message.effects.length; i++)
            SideEffect.internalBinaryWrite(message.effects[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* eigr.functions.protocol.Pipe pipe = 3; */
        if (message.routing.oneofKind === "pipe")
            Pipe.internalBinaryWrite(message.routing.pipe, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* eigr.functions.protocol.Forward forward = 4; */
        if (message.routing.oneofKind === "forward")
            Forward.internalBinaryWrite(message.routing.forward, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class InvocationRequest$Type extends MessageType<InvocationRequest> {
    constructor() {
        super("eigr.functions.protocol.InvocationRequest", [
            ...
            { no: 9, name: "scheduled_to", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 10, name: "pooled", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value?: PartialMessage<InvocationRequest>): InvocationRequest {
        const message = { actionName: "", payload: { oneofKind: undefined }, async: false, metadata: {}, scheduledTo: 0n, pooled: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    private binaryReadMap8(map: InvocationRequest["metadata"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof InvocationRequest["metadata"] | undefined, val: InvocationRequest["metadata"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field eigr.functions.protocol.InvocationRequest.metadata");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message: InvocationRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.payload.oneofKind === "value")
            Any.internalBinaryWrite(message.payload.value, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* eigr.functions.protocol.Noop noop = 7; */
        if (message.payload.oneofKind === "noop")
            Noop.internalBinaryWrite(message.payload.noop, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        /* bool async = 5; */
        if (message.async !== false)
            writer.tag(5, WireType.Varint).bool(message.async);
        /* eigr.functions.protocol.actors.ActorId caller = 6; */
        if (message.caller)
            ActorId.internalBinaryWrite(message.caller, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.scheduledTo !== 0n)
            writer.tag(9, WireType.Varint).int64(message.scheduledTo);
        /* bool pooled = 10; */
        if (message.pooled !== false)
            writer.tag(10, WireType.Varint).bool(message.pooled);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ActorInvocation$Type extends MessageType<ActorInvocation> {
    ...
    create(value?: PartialMessage<ActorInvocation>): ActorInvocation {
        const message = { actionName: "", payload: { oneofKind: undefined } };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* eigr.functions.protocol.actors.ActorId actor */ 1:
                    message.actor = ActorId.internalBinaryRead(reader, reader.uint32(), options, message.actor);
                    break;
                case /* string action_name */ 2:
                    message.actionName = reader.string();
                    break;
    ...
    internalBinaryWrite(message: ActorInvocation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.actor)
            ActorId.internalBinaryWrite(message.actor, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* string action_name = 2; */
        if (message.actionName !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.actionName);
        /* eigr.functions.protocol.Context current_context = 3; */
        if (message.currentContext)
            Context.internalBinaryWrite(message.currentContext, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* google.protobuf.Any value = 4; */
        if (message.payload.oneofKind === "value")
            Any.internalBinaryWrite(message.payload.value, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* eigr.functions.protocol.Noop noop = 5; */
        if (message.payload.oneofKind === "noop")
            Noop.internalBinaryWrite(message.payload.noop, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        /* eigr.functions.protocol.actors.ActorId caller = 6; */
        if (message.caller)
            ActorId.internalBinaryWrite(message.caller, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
class ActorInvocationResponse$Type extends MessageType<ActorInvocationResponse> {
    ...
    internalBinaryWrite(message: ActorInvocationResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.payload.oneofKind === "noop")
            Noop.internalBinaryWrite(message.payload.noop, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
