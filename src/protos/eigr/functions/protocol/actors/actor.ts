...
export enum Kind {
  ...
  PROXY = 4,
  /**
   * @generated from protobuf enum value: TASK = 5;
   */
  TASK = 5
}
...
class Registry$Type extends MessageType<Registry> {
  ...
  internalBinaryWrite(
    ...
    for (let k of globalThis.Object.keys(message.actors)) {
...
class FixedTimerAction$Type extends MessageType<FixedTimerAction> {
  ...
  create(value?: PartialMessage<FixedTimerAction>): FixedTimerAction {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.seconds = 0
    if (value !== undefined) reflectionMergePartial<FixedTimerAction>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class ActorSettings$Type extends MessageType<ActorSettings> {
  ...
  create(value?: PartialMessage<ActorSettings>): ActorSettings {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.kind = 0
    message.stateful = false
    message.minPoolSize = 0
    message.maxPoolSize = 0
...
class Actor$Type extends MessageType<Actor> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated eigr.functions.protocol.actors.FixedTimerAction timer_actions */ 5:
          message.timerActions.push(
            FixedTimerAction.internalBinaryRead(reader, reader.uint32(), options)
          )
          break
        default:
          let u = options.readUnknownField
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.timerActions.length; i++)
      FixedTimerAction.internalBinaryWrite(
        message.timerActions[i],
