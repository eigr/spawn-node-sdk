 ...
 *
 * @generated from protobuf message eigr.functions.protocol.actors.Action
 */
 ...
 *
 * @generated from protobuf message eigr.functions.protocol.actors.FixedTimerAction
 */
export interface FixedTimerAction {
    /**
     ...
     *
     * @generated from protobuf field: eigr.functions.protocol.actors.Action action = 2;
     */
    action?: Action;
}
/**
...
export interface Actor {
     ...
     *
     * @generated from protobuf field: repeated eigr.functions.protocol.actors.Action actions = 4;
     */
    actions: Action[];
    /**
     * The registered timer actions for an actor.
     *
     * @generated from protobuf field: repeated eigr.functions.protocol.actors.FixedTimerAction timer_actions = 5;
     */
    timerActions: FixedTimerAction[];
}
/**
...
class ActorDeactivationStrategy$Type extends MessageType<ActorDeactivationStrategy> {
    ...
    create(value?: PartialMessage<ActorDeactivationStrategy>): ActorDeactivationStrategy {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ActorDeactivationStrategy>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ActorDeactivationStrategy): ActorDeactivationStrategy {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ActorDeactivationStrategy, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* eigr.functions.protocol.actors.TimeoutStrategy timeout = 1; */
        if (message.strategy.oneofKind === "timeout")
            TimeoutStrategy.internalBinaryWrite(message.strategy.timeout, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
class Action$Type extends MessageType<Action> {
    constructor() {
        super("eigr.functions.protocol.actors.Action", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message eigr.functions.protocol.actors.Action
 */
export const Action = new Action$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FixedTimerAction$Type extends MessageType<FixedTimerAction> {
    constructor() {
        super("eigr.functions.protocol.actors.FixedTimerAction", [
            { no: 1, name: "seconds", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "action", kind: "message", T: () => Action }
        ]);
    }
    create(value?: PartialMessage<FixedTimerAction>): FixedTimerAction {
        const message = { seconds: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<FixedTimerAction>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FixedTimerAction): FixedTimerAction {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* int32 seconds */ 1:
                    ...
                    break;
                case /* eigr.functions.protocol.actors.Action action */ 2:
    ...
    internalBinaryWrite(message: FixedTimerAction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 seconds = 1; */
        if (message.seconds !== 0)
            writer.tag(1, WireType.Varint).int32(message.seconds);
        /* eigr.functions.protocol.actors.Action action = 2; */
        if (message.action)
            Action.internalBinaryWrite(message.action, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message eigr.functions.protocol.actors.FixedTimerAction
 */
export const FixedTimerAction = new FixedTimerAction$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class Metadata$Type extends MessageType<Metadata> {
    ...
    private binaryReadMap2(map: Metadata["tags"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof Metadata["tags"] | undefined, val: Metadata["tags"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field eigr.functions.protocol.actors.Metadata.tags");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class ActorSettings$Type extends MessageType<ActorSettings> {
    ...
    create(value?: PartialMessage<ActorSettings>): ActorSettings {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ActorSettings>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ActorSettings): ActorSettings {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* eigr.functions.protocol.actors.ActorDeactivationStrategy deactivation_strategy */ 4:
                    message.deactivationStrategy = ActorDeactivationStrategy.internalBinaryRead(reader, reader.uint32(), options, message.deactivationStrategy);
                    break;
    ...
    internalBinaryWrite(message: ActorSettings, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* eigr.functions.protocol.actors.Kind kind = 1; */
        if (message.kind !== 0)
            writer.tag(1, WireType.Varint).int32(message.kind);
        /* bool stateful = 2; */
        if (message.stateful !== false)
            writer.tag(2, WireType.Varint).bool(message.stateful);
        /* eigr.functions.protocol.actors.ActorSnapshotStrategy snapshot_strategy = 3; */
        if (message.snapshotStrategy)
            ActorSnapshotStrategy.internalBinaryWrite(message.snapshotStrategy, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* eigr.functions.protocol.actors.ActorDeactivationStrategy deactivation_strategy = 4; */
        if (message.deactivationStrategy)
            ActorDeactivationStrategy.internalBinaryWrite(message.deactivationStrategy, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* int32 min_pool_size = 5; */
        if (message.minPoolSize !== 0)
            writer.tag(5, WireType.Varint).int32(message.minPoolSize);
        /* int32 max_pool_size = 6; */
        if (message.maxPoolSize !== 0)
            writer.tag(6, WireType.Varint).int32(message.maxPoolSize);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ActorId$Type extends MessageType<ActorId> {
    ...
    create(value?: PartialMessage<ActorId>): ActorId {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ActorId>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ActorId): ActorId {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ActorId, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.name);
        /* string system = 2; */
        if (message.system !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.system);
        /* string parent = 3; */
        if (message.parent !== "")
...
class Actor$Type extends MessageType<Actor> {
    constructor() {
        super("eigr.functions.protocol.actors.Actor", [
            ...
            { no: 4, name: "actions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Action },
            { no: 5, name: "timer_actions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FixedTimerAction }
        ]);
    }
    create(value?: PartialMessage<Actor>): Actor {
        const message = { actions: [], timerActions: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* eigr.functions.protocol.actors.ActorSettings settings */ 3:
                    message.settings = ActorSettings.internalBinaryRead(reader, reader.uint32(), options, message.settings);
                    break;
                case /* repeated eigr.functions.protocol.actors.Action actions */ 4:
                    message.actions.push(Action.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated eigr.functions.protocol.actors.FixedTimerAction timer_actions */ 5:
                    message.timerActions.push(FixedTimerAction.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: Actor, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.id)
            ActorId.internalBinaryWrite(message.id, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* eigr.functions.protocol.actors.ActorState state = 2; */
        if (message.state)
            ActorState.internalBinaryWrite(message.state, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.settings)
            ActorSettings.internalBinaryWrite(message.settings, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* repeated eigr.functions.protocol.actors.Action actions = 4; */
        for (let i = 0; i < message.actions.length; i++)
            Action.internalBinaryWrite(message.actions[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* repeated eigr.functions.protocol.actors.FixedTimerAction timer_actions = 5; */
        for (let i = 0; i < message.timerActions.length; i++)
            FixedTimerAction.internalBinaryWrite(message.timerActions[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
